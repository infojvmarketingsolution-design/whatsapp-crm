...
const ContactSchema = new mongoose.Schema({
  ...
  status: { type: String, enum: ['LEAD', 'NEW LEAD', 'CONTACTED', 'INTERESTED', 'FOLLOW_UP', 'CLOSED_WON', 'CLOSED_LOST', 'OPEN', 'CLOSED', 'ADMISSION', 'VISITED', 'PENDING_VISIT', 'CAMPAIGN', 'NEW', 'CLOSE'], default: 'NEW LEAD' },
