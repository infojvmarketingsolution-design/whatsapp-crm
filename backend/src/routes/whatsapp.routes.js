...
const { verifyWebhook, handleIncomingMessage, getApiConfig, saveApiConfig, testApiConnection, exchangeFacebookToken, getMetaStatus } = require('../controllers/whatsapp.controller');
...
router.get('/meta-status', protect, tenantMiddleware, getMetaStatus);
