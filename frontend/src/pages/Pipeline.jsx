...
const STATUSES = [
  ...
  { id: 'NEEDS FOLLOW-UP', label: 'Needs Follow-Up', color: 'bg-yellow-100 text-yellow-800 border-yellow-200', icon: Calendar },
...
export default function Pipeline() {
  ...
  return (
    <div className="flex-1 bg-white lg:rounded-3xl shadow-[0_4px_30px_rgb(0,0,0,0.06)] overflow-hidden border border-gray-50 flex flex-col relative z-10 w-full lg:w-[calc(100%-24px)] lg:ml-3 lg:my-3 lg:mr-3">
      ...
      <div className="flex-1 overflow-x-auto p-4 lg:p-6 bg-[#fcfcfd] snap-x snap-mandatory scroll-smooth custom-scrollbar">
        <div className="flex space-x-4 lg:space-x-6 h-full min-w-max pb-4">
          {STATUSES.map(stage => {
                    ...
                    >
                      ...
                      <div className="flex items-center justify-between pt-3 border-t border-gray-50">
                        ...
                        <div className="flex space-x-2">
                           ...
                           <button onClick={() => navigate('/inbox')} className="w-8 h-8 rounded-xl bg-slate-50 flex items-center justify-center text-slate-500 hover:text-blue-600 hover:bg-blue-50 transition-all border border-transparent hover:border-blue-200">
                              <Phone size={14}/>
                           </button>
                        </div>
                      </div>
